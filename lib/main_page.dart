...
class _MainPageState extends State<MainPage> {
  ...
  void showBingo(){
    ...
    builder: (context) => AlertDialog(
      ...
      actions: [
        ElevatedButton(onPressed: (){Navigator.of(context).pop(false);}, child: Text("OK?"))
      ],
    ...
    return Container(
      decoration: BoxDecoration(
          gradient: LinearGradient(
              colors: [Color.fromRGBO(255, 109, 51, 1),Color.fromRGBO(77, 86, 245, 1)],
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ElevatedButton(onPressed: showBingo, child: Text("data")),
            Text(
              "FRIEND BINGO",
                  ...
                  children: [
                    for (int i = 0; i < tasks.length; i++)
                      Container(
                        decoration: BoxDecoration(
                          border: Border(
                            right:BorderSide(color: Colors.black, width:  i % size == size-1 ? 2 : 1),
                            bottom: BorderSide(color: Colors.black, width:  i > tasks.length - size - 1 ? 2 : 1),
                            left: BorderSide(color: Colors.black, width:  i % size == 0 ? 2 : 1),
